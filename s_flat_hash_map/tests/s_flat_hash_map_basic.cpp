...
static void test_basic_operations_u32_soa() {
...
static void test_insert_range_and_init_list_u32_soa() {
    using map_t = mcl::flat_hash_map_u32_soa<UInt32>;
    map_t m;
...
static void test_shrink_to_fit_u32_soa() {
    using map_t = mcl::flat_hash_map_u32_soa<UInt32>;
...
static void test_high_collision_u32_soa() {
...
static void test_load_factor_and_rehash_u32_soa() {
    using map_t = mcl::flat_hash_map_u32_soa<UInt32>;
    map_t m;
    m.max_load_factor(0.5f);
    m.reserve(8);
...
static void test_insert_erase_insert_cycle_u32_soa() {
    using map_t = mcl::flat_hash_map_u32_soa<UInt32>;
...
static void test_iterators_u32_soa() {
    using map_t = mcl::flat_hash_map_u32_soa<UInt32>;
...
static void test_allocator_behavior_u32_soa() {
    using value_type = std::pair<UInt32, UInt32>;
...
int main() {
    ...
    test_basic_operations_u32_soa();
    std::cout << "  basic_operations OK\n";

    test_insert_range_and_init_list_u32_soa();
    std::cout << "  insert range/init list OK\n";

    test_shrink_to_fit_u32_soa();
    std::cout << "  shrink_to_fit OK\n";

    test_high_collision_u32_soa();
    std::cout << "  high_collision OK\n";

    test_load_factor_and_rehash_u32_soa();
    std::cout << "  load_factor / rehash OK\n";

    test_insert_erase_insert_cycle_u32_soa();
    std::cout << "  insert/erase/insert cycle OK\n";

    test_iterators_u32_soa();
    std::cout << "  iterators OK\n";

    test_allocator_behavior_u32_soa();
    std::cout << "  allocator behavior OK\n";
